...
import com.soc.orderservice.dto.ApiResponse;
...
public class OrderController {
    ...
    public ResponseEntity<ApiResponse<OrderResponse>> getOrderByIdOrNumber(
        ...
        OrderResponse order = orderService.getOrderByIdOrNumber(identifier, username, role);
    ...
    public ResponseEntity<ApiResponse<Page<OrderResponse>>> getAllOrders(
        ...
        if (role != null && !"ROLE_ADMIN".equals(role) && username != null) {
            customerId = username;
        }
    ...
    public ResponseEntity<ApiResponse<OrderResponse>> processPaymentWebhook(
        ...
        OrderResponse updated = orderService.processPaymentWebhook(id, signature, request);
